...
public class FPSoftwareMessageUpdate extends FPMessage{
	...
	public FPSoftwareMessageUpdate(Integer messageId, String customerId, String buildingId,
			String softwareMessage) {
		super(messageId, System.currentTimeMillis(),StaticMessages.MESSAGE_TYPE_REQ_SOFTWARE_MESSAGE_UPDATE);
