...
import com.vision.amclient.ui.LogsUI.StartEndLoc;
...
public class SystemMessagesUI extends JFrame implements ActionListener,
	...
	public SystemMessagesUI(boolean colorText) {
		super("Fire Panel Client - System Messages");
	...
	public void actionPerformed(ActionEvent ae) {
		if (ae.getSource() == jb) {
			...
			textPane.setText("");
			textPane.repaint();
			AlarmMonitor.getInstance().systemLogMessages.clear();
		}

	}

	public void refereshMessages(Vector<AlarmMessage> messages) {
		...
		for (int i = (messages.size() - 1); i >= 0; i--) {
			AlarmMessage message = messages.get(i);
