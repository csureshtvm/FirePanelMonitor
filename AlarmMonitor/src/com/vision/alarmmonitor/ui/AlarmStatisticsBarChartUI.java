...
public class AlarmStatisticsBarChartUI extends JPanel{
	    ...
	    String xAxis = "Customer";
	    String yAxisStr = "No Of Alarms";
	    String title = "Customer/Alarm Statistics(Last Month)";
	    ...
	    Font xFont = new Font("Arial", Font.PLAIN, 12);
	     ...
	     */
	    AlarmStatisticsBarChartUI(ArrayList<Bar> bars, Axis yAxis) {
	        this.bars = bars;
	        this.yAxis = yAxis;
	    ...
	    protected void paintComponent(Graphics g) {
	       ...
	       // g2d.setColor(AppConstants.SCREEN_BG_COLOR);
	    ...
	    public static void main(String[] args) {
			 ...
			 values.add(new Bar(30, Color.blue, "Test1"));
			 values.add(new Bar(10, Color.red, "Test2"));
			 values.add(new Bar(3, Color.green, "Test3"));
		    Axis axis=new Axis(40,3,10,20,30,"No Of Alarms");
			AlarmStatisticsBarChartUI barChart=new AlarmStatisticsBarChartUI(values, axis);
			
			JFrame jf=new JFrame();
			jf.add(barChart);
			jf.getContentPane().setLayout(null);
			barChart.setBounds(0, 0, 600, 400);
			jf.setVisible(true);
