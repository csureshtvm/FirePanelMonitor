...
public class BuildingDemo extends JPanel implements ActionListener{
	 ...
	 @Override
	    protected void paintComponent(Graphics g) {
	      ...
	      /* if(jl1!=null && jl2!=null){
	        ...
	        int floorHeight=totalFloorHeight/totalFloors;
	  ...
	  public static void main(String[] args) {
	        SwingUtilities.invokeLater(new Runnable() {
	            public void run() {
	                ...
	                BuildingDemo bd=new BuildingDemo();
	                
	               Container c= frame.getContentPane();
	                c.setLayout(null);
	                c.add(bd);
	                bd.setBounds(0,0,800,650);
	...
	public void actionPerformed(ActionEvent ae) {
		if(ae.getSource()==jb){
			//setBuildingParams(100, 200, 20, 20, 10, 10, 5, 2);
			repaint();
		}
